...
from config import (
    TCP_PORT, DRONE_NAMES, DRONE_RANGE, DRONE_HEIGHT, SPEED, X_MAX, Y_MAX, duration, PROPAGATION_MODEL, ATTENUATION
)
...
def setup_topology():
    ...
    net.setMobilityModel(time=0, model='GaussMarkov', max_x=X_MAX, max_y=Y_MAX, velocity=SPEED, seed=20)
